...
class CondenseQueryTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_rewrites_when_pronoun_present(self):
        ...
        history = [
            HumanMessage(content="What skills do Nords have?"),
...
class ToHistoryTests(unittest.TestCase):
    def test_to_history_excludes_final_user_turn(self):
        ...
        msgs = [
            OpenAIMessage(role="system", content="You are Lydia."),
